...
For step-by-step instructions on how to modify the available bandwidth for your Elastic Metal server, please refer to our documentation: [How to adjust the available bandwidth for an Elastic Metal server](/bare-metal/elastic-metal/how-to/adjust-available-bandwidth//).
