...
Dedibox is our historical dedicated server range, only available with monthly billing.
...
Elastic Metal servers can be billed per hour or month.
...
For step-by-step instructions on how to modify the available bandwidth for your Elastic Metal server, please refer to our documentation: [How to modify the available bandwidth for an Elastic Metal server](/bare-metal/elastic-metal/how-to/modify-available-bandwidth/).
...
You can reinstall an Elastic Metal server with a few clicks at any time, [directly from your management console](/bare-metal/elastic-metal/how-to/install-server/).
...
Yes, Elastic Metal servers are delivered with an IPv6 address (/128).
