...
<Navigation title="See Also">
  ...
  <NextButton to="/containers/kubernetes/how-to/manage-kubeconfig-with-iam/">How to manage Kubeconfig files with IAM</NextButton>
</Navigation>
